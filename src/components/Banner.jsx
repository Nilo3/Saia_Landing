...
const Banner = () => {
    return (
        <div className='h-full w-full flex flex-col bg-black'>
            ...
            <div className='h-[70vh] w-full bg-center md:bg-top' > 
            <div className="flex flex-col md:flex-row items-center justify-center h-full">
            <div className='z-20 text-center md:text-start md:ml-6 2xl:mr-24 xl:w-96 -mt-12 md:mt-0'>
                <h2 className='text-white text-4xl font-bold 2xl:text-4xl '>Mostreando cambio</h2>
                ...
                <iframe
                    className="rounded-2xl border-2 border-white w-96 h-60  mt-12 md:mt-0 md:w-[360px] md:h-[250px] lg:w-[600px] lg:h-[350px] lg:mt-1 lg:ml-24 2xl:h-[350px] 2xl:w-[700px] 2xl:mr-24"
